      ...
      <div className={styles.headerContainer}>
        ...
        <nav className={styles.nav} aria-label="Main Navigation">
          ...
          >
            ...
            <li className={styles.navItem}>
              <a href="/solutions" className={styles.navLink} onClick={closeMenu}>Solutions</a>
            </li>
            <li className={styles.navItem}>
            ...
            <li className={styles.navItem}>
              <a href="/auth/login" className={styles.navLink} onClick={closeMenu}>Login</a>
            </li>
            <li className={styles.navItem}>
              <button className={styles.ctaButton} onClick={() => window.location.href='/get-started'} aria-label="Get Started">
                Get Started
              </button>
            </li>
          </ul>
